      ...
      <Content style={{ padding: '0 50px', marginTop: 64 }}>
        <div className="site-layout-content">
          ...
          <section id="resume" style={sectionStyle}>
            ...
            <Button type="primary" icon={<DownloadOutlined />} size="large" href="https://drive.google.com/file/d/1T7bhxZejUxOamlK9SsWPvq5mQ6X1wZoq/view?usp=drive_link" target="_blank">
              Download my Resume
            </Button>
          </section>
          <Blog />
